...
def free_bacon(score):
    ...
    pi = FIRST_101_DIGITS_OF_PI
    while True:
        if (pi < pow(10,score+1)) and (pi >= pow(10,score)):
            break
        pi = pi // 10
    # END PROBLEM 2
    return pi % 10 + 3
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    x=0
    #h = announce_lead_changes(last_leader=None)
    h = say
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    def say(score0,score1):
        x = (score0 if who == 0 else score1) - last_score
        if x > running_high:
            print(x,"point(s)! The most yet for Player",who)
            return announce_highest(who,score0 if who == 0 else score1,x)
        return announce_highest(who,score0 if who == 0 else score1,running_high)
    return say
    # END PROBLEM 7
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if free_bacon(opponent_score) > (100-score):
        ...
        return extra_turn_strategy(score, opponent_score, cutoff=5, num_rolls=6)
